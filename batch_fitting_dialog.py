...
class BatchFittingDialog(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Draw main border with proper insets to ensure visibility
        pen = QPen(QColor("#7E57C2"), 3)  # Thicker border
        pen.setStyle(Qt.PenStyle.SolidLine)
        pen.setCapStyle(Qt.PenCapStyle.RoundCap)
        pen.setJoinStyle(Qt.PenJoinStyle.RoundJoin)
        painter.setPen(pen)
        
        # Draw rounded rectangle - adjusted to be INSIDE the widget bounds
        # Using larger insets to ensure the border is fully visible
        border_rect = rect.adjusted(2, 2, -4, -4)
        painter.drawRoundedRect(border_rect, 6, 6)
        
        # Draw EXPLICIT thick right border line to make it VERY visible
        pen_explicit = QPen(QColor("#7E57C2"), 4)  # Even thicker
        pen_explicit.setCapStyle(Qt.PenCapStyle.RoundCap)
        painter.setPen(pen_explicit)
        
        # Right vertical line - positioned well inside the widget bounds
        right_x = rect.width() - 4  # 4px from right edge (more conservative)
        painter.drawLine(right_x, 10, right_x, rect.height() - 10)
        
        # Bottom horizontal line (right portion for emphasis)
        bottom_y = rect.height() - 4  # 4px from bottom edge
        painter.drawLine(rect.width() // 2, bottom_y, right_x, bottom_y)
    ...
    def setup_ui(self):
        ...
        main_layout.setContentsMargins(5, 5, 10, 10)  # Balanced margins for border
        ...
        layout.setContentsMargins(8, 8, 8, 8)  # Uniform margins
        layout.setSpacing(5)
        ...
        header_layout.setContentsMargins(8, 5, 8, 5)  # Uniform horizontal margins
    ...
    def create_right_panel(self):
        ...
        panel = QWidget()
        layout = QVBoxLayout(panel)
        layout.setContentsMargins(5, 5, 5, 5)  # Uniform margins
        layout.setSpacing(5)
    ...
    def create_control_bar(self):
        ...
        main_layout.setContentsMargins(10, 5, 10, 5)  # Uniform horizontal margins
    ...
    def create_navigation_bar(self):
        ...
        layout.setContentsMargins(10, 5, 10, 5)  # Uniform horizontal margins
