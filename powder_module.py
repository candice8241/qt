...
class PowderXRDModule(GUIBase):
    ...
    def setup_ui(self):
        ...
        print("[PowderModule] setup_ui() called")
        print(f"[PowderModule] Parent widget: {self.parent}")
        
        # Get or create layout for parent
        layout = self.parent.layout()
        if layout is None:
            print("[PowderModule] Creating new layout for parent")
            layout = QVBoxLayout(self.parent)
            layout.setContentsMargins(0, 0, 0, 0)
        else:
            print("[PowderModule] Using existing parent layout")
            print(f"[PowderModule] Existing layout type: {type(layout).__name__}")
        
        print(f"[PowderModule] Layout widget count before: {layout.count()}")
        ...
        # Setup modules
        print("[PowderModule] Setting up integration module...")
        self.setup_integration_module(content_layout)
        
        print("[PowderModule] Setting up analysis module...")
        ...
        print("[PowderModule] Adding scroll to layout...")
        scroll.setWidget(content_widget)
        layout.addWidget(scroll)
        
        print(f"[PowderModule] Layout widget count after: {layout.count()}")
        print("[PowderModule] setup_ui() complete")
    ...
    def setup_integration_module(self, parent_layout):
        ...
        print("[PowderModule] setup_integration_module() called")
        ...
        print("[PowderModule] Integration module UI setup complete")

    def setup_analysis_module(self, parent_layout):
        """Setup analysis module UI following provided mockups"""
        print("[PowderModule] setup_analysis_module() called")
        ...
        frame_container.setStyleSheet(f"background-color: {self.colors['card_bg']};")
        frame_container_layout = QHBoxLayout(frame_container)
        frame_container_layout.setContentsMargins(0, 0, 0, 0)
        ...
        frame_container_layout.addWidget(combined_frame)
        frame_container_layout.addStretch()

        right_layout.addWidget(frame_container)
        right_layout.addStretch()
        ...
        print("[PowderModule] Analysis module UI setup complete")
