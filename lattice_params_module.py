...
class LatticeParamsModule(QWidget, GUIBase):
    ...
    def setup_lattice_params_card(self, parent_layout):
        ...
        right_title.setStyleSheet(f"color: {self.colors['text_dark']}; background-color: {self.colors['card_bg']};border:none;")
        ...
        wl_label.setStyleSheet(f"color: {self.colors['text_dark']}; background-color: transparent;border:none;")
