...
class AzimuthalIntegrationModule(GUIBase):
    ...
    def setup_integration_module(self, parent_layout):
        ...
        formats_label.setStyleSheet(f"color: #666666; background-color: {self.colors['card_bg']};")
        ...
        viz_label.setStyleSheet(f"color: #666666; background-color: {self.colors['card_bg']};")
        ...
        offset_hint.setStyleSheet("color: #999999;")
